...
const Isbh2025 = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 transition-colors duration-300">
      ...
      {/* Navigation Tabs */}
      <section className="sticky top-16 z-40 bg-gray-900 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="p-6">
                    <div className="space-y-3">
                      {day.events.map((event, eventIndex) => (
                        <div key={eventIndex} className="flex items-center justify-between py-2 border-b border-gray-700 last:border-b-0">
                          <div className="flex items-center space-x-4">
                            <span className="text-sm font-medium text-blue-400 w-24">
                              {event.time}
                            </span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {confirmedSpeakers.map((speaker, index) => (
            <div
              key={index}
              className="bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition"
            >
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div className="flex items-center bg-green-900 rounded-lg p-4"
                  >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/contact"
                className="inline-flex items-center px-8 py-3 border-2 border-blue-400 text-blue-400 rounded-lg font-semibold hover:bg-aiims-blue hover:text-white transition-colors duration-200"
              >
                Contact Information
              </a>
            </div>
